...
export function RooftopsTableHeader({ sortField, sortDirection, onSort }: RooftopsTableHeaderProps) {
  ...
  return (
    <thead className="border-b border-gray-200">
      <tr>
        {/* Removed Rooftops column */}
        <HeaderCell field="groupDealer" className="min-w-[180px]" isSticky={true}>Enterprise Name</HeaderCell>
        <HeaderCell field="accountExecutivePOC" className="min-w-[180px]">AE POC</HeaderCell>
        ...
        <HeaderCell field="platform" className="min-w-[180px]">Platform</HeaderCell>
        <HeaderCell field="type" className="min-w-[180px]">Type</HeaderCell>
        <HeaderCell field="subType" className="min-w-[180px]">Sub Type</HeaderCell>
        ...
        <HeaderCell field="vinsAlloted" className="w-max whitespace-nowrap">VINs Alloted</HeaderCell>
        ...
        <HeaderCell field="paymentsFrequency" className="w-max whitespace-nowrap">Payments Frequency</HeaderCell>
